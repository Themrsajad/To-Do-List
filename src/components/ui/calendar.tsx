  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "text-sm font-bold font-[Quicksand] no-select",
        nav: "space-x-1 flex items-center",
        nav_button: "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100",
        nav_button_previous: "absolute left-1",
        nav_button_next: "absolute right-1",
        table: "w-full border-collapse space-y-1",
        head_row: "flex bg-aLight/15 dark:bg-bDark/15 rounded-lg no-select",
        head_cell:
        ...
        day: "h-9 w-9 p-0 rounded-lg font-semibold font-[Quicksand] aria-selected:opacity-100 hover:cursor-pointer no-select",
